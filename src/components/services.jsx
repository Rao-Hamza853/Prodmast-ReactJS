...
const Services = () => {
  return (
    <div className='space-y-6 px-8 lg:px-14 xl:px-20 bg-[#0C363C] pt-20 pb-20'>
      <h1 className='text-4xl font-bold text-center text-white'>Efficient and Integrated <br /> Manufacturing Services</h1>
      ...
      <div className="grid grid-cols-3 gap-x-2 gap-y-7 pt-8">
        <div className="flex flex-col gap-y-16 rounded-2xl p-8 bg-[#143E44] w-[95%] justify-between">
