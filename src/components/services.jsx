...
const Services = () => {
  return (
    <div className='space-y-6 px-6 lg:px-12 xl:px-16 2xl:px-20 bg-[#0C363C] pt-10 lg:pt-20 pb-20'>
      ...
      <div className="grid grid-cols-1 gap-y-5 md:grid-cols-2 md:gap-x-2 md:gap-y-3 lg:grid-cols-3 lg:gap-y-7 pt-8">
        <div className="flex flex-col h-[270px] md:h-auto gap-y-16 rounded-2xl p-6 lg:p-8 bg-[#143E44] lg:w-[95%] justify-between">
