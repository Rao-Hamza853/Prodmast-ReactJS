...
const Integrations = () => {
  return (
    <div className="px-6 lg:px-12 xl:px-16 2xl:px-20 pt-10 lg:pt-20 pb-10 lg:pb-20 flex flex-col gap-y-10 lg:flex-row lg:justify-between lg:items-center 2xl:justify-center 2xl:gap-x-36">
